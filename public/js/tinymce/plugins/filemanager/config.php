...
$base_url="https://edwardspeedforce.com/pusocial"; //url base of site if you want only relative url leave empty
$upload_dir = '/images/uploads/'; // path from base_url to upload base dir
