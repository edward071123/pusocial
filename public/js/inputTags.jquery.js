(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            empty: '很抱歉，您不能新增空的標籤喔',
            minLength: '很抱歉，您最少要輸入%s個字唷，請您再試一次',
            maxLength: '很抱歉，您標籤文字不能超過 %s 個字，請您再試一次',
            max: '嗨，您的標籤數量不能超過%s個喔',
            email: '很抱歉, 您輸入的Email地址是錯誤或是無效的',
            exists: '嗨~您這個標籤已經存在了唷',
            autocomplete_only: '很抱歉，您必須從列表中選擇一個。',
            timeout: 8000
        }
    };
